/* Process model C form file: WSN_MAC_UP_NEW.pr.c */
...
#define FIN_PREAMBLE_DEC	WSN_MAC_UP_NEW_state *op_sv_ptr;
#define FIN_PREAMBLE_CODE	\
		op_sv_ptr = ((WSN_MAC_UP_NEW_state *)(OP_SIM_CONTEXT_PTR->_op_mod_state_ptr));
...
extern "C" {
#endif
	void WSN_MAC_UP_NEW (OP_SIM_CONTEXT_ARG_OPT);
	VosT_Obtype _op_WSN_MAC_UP_NEW_init (int * init_block_ptr);
	void _op_WSN_MAC_UP_NEW_diag (OP_SIM_CONTEXT_ARG_OPT);
	void _op_WSN_MAC_UP_NEW_terminate (OP_SIM_CONTEXT_ARG_OPT);
	VosT_Address _op_WSN_MAC_UP_NEW_alloc (VosT_Obtype, int);
	void _op_WSN_MAC_UP_NEW_svar (void *, const char *, void **);
...
void
WSN_MAC_UP_NEW (OP_SIM_CONTEXT_ARG_OPT)
	{
#if !defined (VOSD_NO_FIN)
	int _op_block_origin = 0;
#endif
	FIN_MT (WSN_MAC_UP_NEW ());

		{


		FSM_ENTER ("WSN_MAC_UP_NEW")

		FSM_BLOCK_SWITCH
			{
			/*---------------------------------------------------------*/
			/** state (init) enter executives **/
			FSM_STATE_ENTER_FORCED_NOLABEL (0, "init", "WSN_MAC_UP_NEW [init enter execs]")
				FSM_PROFILE_SECTION_IN ("WSN_MAC_UP_NEW [init enter execs]", state0_enter_exec)
				{
			...
			FSM_STATE_EXIT_FORCED (0, "init", "WSN_MAC_UP_NEW [init exit execs]")


			/** state (init) transition processing **/
			FSM_TRANSIT_FORCE (6, state6_enter_exec, ;, "default", "", "init", "waiting", "tr_3", "WSN_MAC_UP_NEW [init -> waiting : default / ]")
				/*---------------------------------------------------------*/



			/** state (scan) enter executives **/
			FSM_STATE_ENTER_UNFORCED (1, "scan", state1_enter_exec, "WSN_MAC_UP_NEW [scan enter execs]")
				FSM_PROFILE_SECTION_IN ("WSN_MAC_UP_NEW [scan enter execs]", state1_enter_exec)
				{
				int framecontrol;
				int type;
				double freq;
			...
			FSM_EXIT (3,"WSN_MAC_UP_NEW")


			/** state (scan) exit executives **/
			FSM_STATE_EXIT_UNFORCED (1, "scan", "WSN_MAC_UP_NEW [scan exit execs]")


			/** state (scan) transition processing **/
			FSM_PROFILE_SECTION_IN ("WSN_MAC_UP_NEW [scan trans conditions]", state1_trans_conds)
			...
			FSM_TRANSIT_SWITCH
				{
				FSM_CASE_TRANSIT (0, 6, state6_enter_exec, ;, "g_mac_scan_flag == NO_SCAN", "", "scan", "waiting", "tr_10", "WSN_MAC_UP_NEW [scan -> waiting : g_mac_scan_flag == NO_SCAN / ]")
				FSM_CASE_TRANSIT (1, 1, state1_enter_exec, ;, "default", "", "scan", "scan", "tr_14", "WSN_MAC_UP_NEW [scan -> scan : default / ]")
				}
				/*---------------------------------------------------------*/
			...
			FSM_STATE_ENTER_UNFORCED (2, "associating", state2_enter_exec, "WSN_MAC_UP_NEW [associating enter execs]")
				FSM_PROFILE_SECTION_IN ("WSN_MAC_UP_NEW [associating enter execs]", state2_enter_exec)
				{
				int type;
				int framecontrol;
				int dest;
			...
			/** blocking after enter executives of unforced state. **/
			FSM_EXIT (5,"WSN_MAC_UP_NEW")


			/** state (associating) exit executives **/
			FSM_STATE_EXIT_UNFORCED (2, "associating", "WSN_MAC_UP_NEW [associating exit execs]")


			/** state (associating) transition processing **/
			FSM_PROFILE_SECTION_IN ("WSN_MAC_UP_NEW [associating trans conditions]", state2_trans_conds)
			...
			FSM_TRANSIT_SWITCH
				{
				FSM_CASE_TRANSIT (0, 3, state3_enter_exec, ;, "C_SELF_ASSOCIATE_SUCCESS", "", "associating", "online", "tr_8", "WSN_MAC_UP_NEW [associating -> online : C_SELF_ASSOCIATE_SUCCESS / ]")
				FSM_CASE_TRANSIT (1, 6, state6_enter_exec, ;, "C_SELF_ASSOCIATE_FAIT", "", "associating", "waiting", "tr_18", "WSN_MAC_UP_NEW [associating -> waiting : C_SELF_ASSOCIATE_FAIT / ]")
				FSM_CASE_TRANSIT (2, 2, state2_enter_exec, ;, "default", "", "associating", "associating", "tr_21", "WSN_MAC_UP_NEW [associating -> associating : default / ]")
				}
				/*---------------------------------------------------------*/
			...
			FSM_STATE_ENTER_UNFORCED (3, "online", state3_enter_exec, "WSN_MAC_UP_NEW [online enter execs]")
				FSM_PROFILE_SECTION_IN ("WSN_MAC_UP_NEW [online enter execs]", state3_enter_exec)
				{
				Packet* pk2;
				Packet* pk;
				int type;
			...
			/** blocking after enter executives of unforced state. **/
			FSM_EXIT (7,"WSN_MAC_UP_NEW")


			/** state (online) exit executives **/
			FSM_STATE_EXIT_UNFORCED (3, "online", "WSN_MAC_UP_NEW [online exit execs]")
				FSM_PROFILE_SECTION_IN ("WSN_MAC_UP_NEW [online exit execs]", state3_exit_exec)
				{
			...
			FSM_PROFILE_SECTION_IN ("WSN_MAC_UP_NEW [online trans conditions]", state3_trans_conds)
			...
			FSM_TRANSIT_SWITCH
				...
				FSM_CASE_TRANSIT (7, 3, state3_enter_exec, ;, "default", "", "online", "online", "tr_130", "WSN_MAC_UP_NEW [online -> online : default / ]")
				}
				/*---------------------------------------------------------*/
			...
			FSM_STATE_ENTER_FORCED (4, "msg from up", state4_enter_exec, "WSN_MAC_UP_NEW [msg from up enter execs]")
				FSM_PROFILE_SECTION_IN ("WSN_MAC_UP_NEW [msg from up enter execs]", state4_enter_exec)
				{
				int framecontrol;
				int type;
				Packet* pk;
			...
			FSM_STATE_EXIT_FORCED (4, "msg from up", "WSN_MAC_UP_NEW [msg from up exit execs]")


			/** state (msg from up) transition processing **/
			FSM_TRANSIT_FORCE (3, state3_enter_exec, ;, "default", "", "msg from up", "online", "tr_70", "WSN_MAC_UP_NEW [msg from up -> online : default / ]")
				/*---------------------------------------------------------*/



			/** state (slot_intrpt) enter executives **/
			FSM_STATE_ENTER_FORCED (5, "slot_intrpt", state5_enter_exec, "WSN_MAC_UP_NEW [slot_intrpt enter execs]")
				FSM_PROFILE_SECTION_IN ("WSN_MAC_UP_NEW [slot_intrpt enter execs]", state5_enter_exec)
				{
				int i;
				double band;
				int frequency;
			...
			FSM_STATE_EXIT_FORCED (5, "slot_intrpt", "WSN_MAC_UP_NEW [slot_intrpt exit execs]")


			/** state (slot_intrpt) transition processing **/
			FSM_TRANSIT_FORCE (3, state3_enter_exec, ;, "default", "", "slot_intrpt", "online", "tr_25", "WSN_MAC_UP_NEW [slot_intrpt -> online : default / ]")
				/*---------------------------------------------------------*/



			/** state (waiting) enter executives **/
			FSM_STATE_ENTER_UNFORCED (6, "waiting", state6_enter_exec, "WSN_MAC_UP_NEW [waiting enter execs]")
				FSM_PROFILE_SECTION_IN ("WSN_MAC_UP_NEW [waiting enter execs]", state6_enter_exec)
				{
				int type;
				int fatherBand;
				int frequency;
			...
			/** blocking after enter executives of unforced state. **/
			FSM_EXIT (13,"WSN_MAC_UP_NEW")


			/** state (waiting) exit executives **/
			FSM_STATE_EXIT_UNFORCED (6, "waiting", "WSN_MAC_UP_NEW [waiting exit execs]")


			/** state (waiting) transition processing **/
			FSM_PROFILE_SECTION_IN ("WSN_MAC_UP_NEW [waiting trans conditions]", state6_trans_conds)
			...
			FSM_TRANSIT_SWITCH
				{
				FSM_CASE_TRANSIT (0, 1, state1_enter_exec, ;, "C_SELF_START_SCAN", "", "waiting", "scan", "tr_4", "WSN_MAC_UP_NEW [waiting -> scan : C_SELF_START_SCAN / ]")
				FSM_CASE_TRANSIT (1, 2, state2_enter_exec, ;, "C_SELF_START_ASSOCIATE", "", "waiting", "associating", "tr_17", "WSN_MAC_UP_NEW [waiting -> associating : C_SELF_START_ASSOCIATE / ]")
				FSM_CASE_TRANSIT (2, 6, state6_enter_exec, ;, "default", "", "waiting", "waiting", "tr_13", "WSN_MAC_UP_NEW [waiting -> waiting : default / ]")
				}
				/*---------------------------------------------------------*/
			...
			FSM_STATE_ENTER_UNFORCED (7, "send", state7_enter_exec, "WSN_MAC_UP_NEW [send enter execs]")
				FSM_PROFILE_SECTION_IN ("WSN_MAC_UP_NEW [send enter execs]", state7_enter_exec)
				{
				int pkptr_size;
				//int count;
				//int slot_number;
			...
			/** blocking after enter executives of unforced state. **/
			FSM_EXIT (15,"WSN_MAC_UP_NEW")


			/** state (send) exit executives **/
			FSM_STATE_EXIT_UNFORCED (7, "send", "WSN_MAC_UP_NEW [send exit execs]")


			/** state (send) transition processing **/
			FSM_PROFILE_SECTION_IN ("WSN_MAC_UP_NEW [send trans conditions]", state7_trans_conds)
			...
			FSM_TRANSIT_SWITCH
				{
				FSM_CASE_TRANSIT (0, 3, state3_enter_exec, ;, "C_SELF_SLOT_COMPLETED", "", "send", "online", "tr_58", "WSN_MAC_UP_NEW [send -> online : C_SELF_SLOT_COMPLETED / ]")
				FSM_CASE_TRANSIT (1, 7, state7_enter_exec, ;, "default", "", "send", "send", "tr_59", "WSN_MAC_UP_NEW [send -> send : default / ]")
				}
				/*---------------------------------------------------------*/
			...
			FSM_STATE_ENTER_FORCED (8, "App_Msg_Up", state8_enter_exec, "WSN_MAC_UP_NEW [App_Msg_Up enter execs]")
				FSM_PROFILE_SECTION_IN ("WSN_MAC_UP_NEW [App_Msg_Up enter execs]", state8_enter_exec)
				{
			...
			FSM_STATE_EXIT_FORCED (8, "App_Msg_Up", "WSN_MAC_UP_NEW [App_Msg_Up exit execs]")


			/** state (App_Msg_Up) transition processing **/
			FSM_TRANSIT_FORCE (3, state3_enter_exec, ;, "default", "", "App_Msg_Up", "online", "tr_112", "WSN_MAC_UP_NEW [App_Msg_Up -> online : default / ]")
				/*---------------------------------------------------------*/



			/** state (MLME) enter executives **/
			FSM_STATE_ENTER_FORCED (9, "MLME", state9_enter_exec, "WSN_MAC_UP_NEW [MLME enter execs]")
				FSM_PROFILE_SECTION_IN ("WSN_MAC_UP_NEW [MLME enter execs]", state9_enter_exec)
				{
				/* recv app data, save in subqueue */
				//int dest;
				int type;
			...
			FSM_STATE_EXIT_FORCED (9, "MLME", "WSN_MAC_UP_NEW [MLME exit execs]")


			/** state (MLME) transition processing **/
			FSM_TRANSIT_FORCE (3, state3_enter_exec, ;, "default", "", "MLME", "online", "tr_109", "WSN_MAC_UP_NEW [MLME -> online : default / ]")
				/*---------------------------------------------------------*/



			/** state (cca_back_off) enter executives **/
			FSM_STATE_ENTER_UNFORCED (10, "cca_back_off", state10_enter_exec, "WSN_MAC_UP_NEW [cca_back_off enter execs]")
				FSM_PROFILE_SECTION_IN ("WSN_MAC_UP_NEW [cca_back_off enter execs]", state10_enter_exec)
				{
				int dest = -1;
				int type = -1;
				int id = -1;
			...
			/** blocking after enter executives of unforced state. **/
			FSM_EXIT (21,"WSN_MAC_UP_NEW")


			/** state (cca_back_off) exit executives **/
			FSM_STATE_EXIT_UNFORCED (10, "cca_back_off", "WSN_MAC_UP_NEW [cca_back_off exit execs]")
				FSM_PROFILE_SECTION_IN ("WSN_MAC_UP_NEW [cca_back_off exit execs]", state10_exit_exec)
				{
			...
			FSM_STATE_ENTER_UNFORCED (11, "transmit", state11_enter_exec, "WSN_MAC_UP_NEW [transmit enter execs]")
				FSM_PROFILE_SECTION_IN ("WSN_MAC_UP_NEW [transmit enter execs]", state11_enter_exec)
				{
				int dest = -1;
				int type = -1;
				int id = -1;
			...
			/** blocking after enter executives of unforced state. **/
			FSM_EXIT (23,"WSN_MAC_UP_NEW")


			/** state (transmit) exit executives **/
			FSM_STATE_EXIT_UNFORCED (11, "transmit", "WSN_MAC_UP_NEW [transmit exit execs]")
				FSM_PROFILE_SECTION_IN ("WSN_MAC_UP_NEW [transmit exit execs]", state11_exit_exec)
				{
			...
			FSM_PROFILE_SECTION_IN ("WSN_MAC_UP_NEW [transmit trans conditions]", state11_trans_conds)
			FSM_INIT_COND (C_SELF_SLOT_COMPLETED)
			FSM_DFLT_COND
			...
			FSM_TRANSIT_SWITCH
				{
				FSM_CASE_TRANSIT (0, 3, state3_enter_exec, slot_complete_flag = 1;, "C_SELF_SLOT_COMPLETED", "slot_complete_flag = 1", "transmit", "online", "tr_123", "WSN_MAC_UP_NEW [transmit -> online : C_SELF_SLOT_COMPLETED / slot_complete_flag = 1]")
				FSM_CASE_TRANSIT (1, 11, state11_enter_exec, ;, "default", "", "transmit", "transmit", "tr_129", "WSN_MAC_UP_NEW [transmit -> transmit : default / ]")
				}
				/*---------------------------------------------------------*/
...
void
_op_WSN_MAC_UP_NEW_diag (OP_SIM_CONTEXT_ARG_OPT)
	{
	/* No Diagnostic Block */
	}
...
void
_op_WSN_MAC_UP_NEW_terminate (OP_SIM_CONTEXT_ARG_OPT)
	{

	FIN_MT (_op_WSN_MAC_UP_NEW_terminate ())
...
/* local variable prs_ptr in _op_WSN_MAC_UP_NEW_svar function. */
#undef subnet_objid
...
VosT_Obtype
_op_WSN_MAC_UP_NEW_init (int * init_block_ptr)
	{
	VosT_Obtype obtype = OPC_NIL;
	FIN_MT (_op_WSN_MAC_UP_NEW_init (init_block_ptr))

	obtype = Vos_Define_Object_Prstate ("proc state vars (WSN_MAC_UP_NEW)",
		sizeof (WSN_MAC_UP_NEW_state));
	*init_block_ptr = 0;
...
VosT_Address
_op_WSN_MAC_UP_NEW_alloc (VosT_Obtype obtype, int init_block)
	{
#if !defined (VOSD_NO_FIN)
	int _op_block_origin = 0;
#endif
	WSN_MAC_UP_NEW_state * ptr;
	FIN_MT (_op_WSN_MAC_UP_NEW_alloc (obtype))

	ptr = (WSN_MAC_UP_NEW_state *)Vos_Alloc_Object (obtype);
	if (ptr != OPC_NIL)
		{
		ptr->_op_current_block = init_block;
#if defined (OPD_ALLOW_ODB)
		ptr->_op_current_state = "WSN_MAC_UP_NEW [init enter execs]";
#endif
		}
...
void
_op_WSN_MAC_UP_NEW_svar (void * gen_ptr, const char * var_name, void ** var_p_ptr)
	{
	WSN_MAC_UP_NEW_state		*prs_ptr;

	FIN_MT (_op_WSN_MAC_UP_NEW_svar (gen_ptr, var_name, var_p_ptr))
	...
	prs_ptr = (WSN_MAC_UP_NEW_state *)gen_ptr;
